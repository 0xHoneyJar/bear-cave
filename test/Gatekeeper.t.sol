...
contract GateKeeperTest is Test, ERC1155TokenReceiver {
    ...
    function testFailStartingGates_NoGates() public {
        uint256 newTokenId = TOKENID + 1;
        gameRegistry.registerGame(address(this));
        gatekeeper.startGatesForBundle(newTokenId);
    }

    function testFail_NotStarted() public view {
        gatekeeper.calculateClaimable(TOKENID, 1, address(0), 1, 1, getProof1(1));
    }
    ...
    function testFailClaim_NotActiveYet() public {
        ...
        gatekeeper.startGatesForBundle(TOKENID);
        uint32 gateIdx = 1;
        gatekeeper.calculateClaimable(TOKENID, gateIdx, address(0), 1, 1, getProof2(1));
    }
    ...
    function testClaim() public {
        ...
        uint32 claimedAmount = gatekeeper.calculateClaimable(TOKENID, gateIdx, player, userIdx, userIdx, proof);
        ...
        claimedAmount = gatekeeper.calculateClaimable(TOKENID, gateIdx, player, userIdx, userIdx, proof);
    ...
    function testNoMoreLeft() public {
        ...
        uint256 claimAmount = gatekeeper.calculateClaimable(TOKENID, gateIdx, player, userIdx, userIdx, proof);
