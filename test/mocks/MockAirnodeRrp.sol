...
import {AuthorizationUtilsV0} from "@api3/airnode-protocol/contracts/rrp/AuthorizationUtilsV0.sol";
import {TemplateUtilsV0} from "@api3/airnode-protocol/contracts/rrp/TemplateUtilsV0.sol";
import {WithdrawalUtilsV0} from "@api3/airnode-protocol/contracts/rrp/WithdrawalUtilsV0.sol";

/// @title Contract that implements the Airnode request–response protocol (RRP)
contract MockAirnodeRrp is AuthorizationUtilsV0, TemplateUtilsV0, WithdrawalUtilsV0, IAirnodeRrpV0 {
    ...
    mapping(uint256 => bytes32) private requestNumToRequestId;
    ...
    /// any)
    // TODO: replace this method with a mock (DELETE)
    // Figure out how to call fullfill without knowing the params.
    function fulfill(
        bytes32 requestId,
        address airnode,
        address fulfillAddress,
        ...
        // );
        // Dont need to check for valid signature
        // require(
